...
// إضافة وظيفة عبر الكود مباشرة (اختياريًا يمكنك تعديل هذه القيم كما تشاء)
  // أضف الوظيفة الأولى
addTaskFromCode('Fizik Ödevi', '65-71');      // أضف الوظيفة الثانية
addTaskFromCode('Kimya Ödev', '58-71')   // أضف الوظيفة الثالثة
...
// يمكنك استدعاء هذه الدالة في أي مكان تريده لمسح البيانات المخزنة.
 // هذه السطر سيحذف الوظائف المخزنة ويعرض قائمة فارغة.
